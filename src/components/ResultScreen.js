    ...
    <div className=" fixed bg-red-500 w-full h-screen z-10 ">
      <div className="flex flex-col items-center h-full justify-center">
        ...
        <div className="flex items-center gap-2 justify-center mb-8">
          <div className="font-press-start text-white text-sm uppercase md:text-base">
            Moves:{props.turns}
          </div>
        ...
        <button
          className=" font-press-start text-white text-2xl uppercase md:text-4xl hover:text-blue-600"
